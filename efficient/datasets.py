...
import efficient.preprocessing
ds_register = functools.partial(efficient.hparams.register, prefix='ds:')
...
def get_dataset_config(name, prefix='ds:'):
  ...
  cfg = efficient.hparams.lookup(name, prefix).cfg
